...
The post-processing of the ANSYS outputs has been carried out in \textbf{Python}, using the libraries \texttt{pandas} for CSV parsing and tabular manipulation, \texttt{matplotlib} for the generation of the frequency response and damping comparison plots, and \texttt{numpy} for the numerical operations. \texttt{seaborn} is used for the convergence plots of \Cref{sec:mesh_convergence}. The code used in the report is available in the project repository: \href{https://github.com/Zalex10GG/vibrations-test}{\texttt{github.com/Zalex10GG/vibrations-test}}. All scripts are listed below for reproducibility:
